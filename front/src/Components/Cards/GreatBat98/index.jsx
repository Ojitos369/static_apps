import styles from '../styles/great_bat_98.module.scss';

const GreatBat98 = props => {
    return (
        <div className={`${styles.card}`}>
            ...
            <div className={`${styles.bottom_section}`}>
                ...
                <div className={`${styles.item}`}>
                    <span className={`${styles.big_text}`}>2626</span>
                    <span className={`${styles.regular_text}`}>UI elements</span>
                </div>
                <div className={`${styles.item}`}>
                    <span className={`${styles.big_text}`}>100%</span>
                    <span className={`${styles.regular_text}`}>Free for use</span>
                </div>
                <div className={`${styles.item}`}>
                    <span className={`${styles.big_text}`}>38,631</span>
                    <span className={`${styles.regular_text}`}>Contributers</span>
                </div>
                </div>
            </div>
        </div>
